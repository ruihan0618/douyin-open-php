...
try {
    $ch = \Visionrhythm\Auth::create([
        ...
        'notify'=> 'https://VisionRhythm.weidun.biz/sdk/example/webhook.php',   //异步通知地址
        'return'=>'https://VisionRhythm.weidun.biz/sdk/example/auth.php',  //同步地址
     ]);
    echo $ch."\r\n";                                       // 输出 返回的支付凭据 Auth
