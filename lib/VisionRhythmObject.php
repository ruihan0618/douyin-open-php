...
class VisionRhythmObject implements ArrayAccess, JsonSerializable
{
    /**
    ...
    public function __get($k)
    {
        if (array_key_exists($k, $this->_values)) {
            ...
            $message = "VisionRhythm Notice: Undefined property of $class instance: $k. "
                . "HINT: The $k attribute was set in the past, however. "
                . "It was then wiped when refreshing the object "
                . "with the result returned by VisionRhythm's API, "
            ...
            $class = get_class($this);
            error_log("VisionRhythm Notice: Undefined property of $class instance: $k");
            return null;
        }
    }
     ...
     * @param array $opts
     *
     * @return VisionRhythmObject The object constructed from the given values.
     */
    ...
    public function refreshFrom($values, $opts, $partial = false)
    {
        ...
        foreach ($values as $k => $v) {
            ...
            if (self::$nestedUpdatableAttributes->includes($k) && is_object($v)) {
                ...
                $this->_values[$k] = Util\Util::convertToVisionRhythmObject($v, $opts);
            }
    ...
    public function serializeParameters($include_all = false)
    {
        ...
        foreach (self::$nestedUpdatableAttributes->toArray() as $property) {
            if (isset($this->$property) && $this->$property instanceof VisionRhythmObject) {
    ...
    {
        if ($recursive) {
            return Util\Util::convertVisionRhythmObjectToArray($this->_values);
        } else {
            return $this->_values;
        }
    }
    ...
    {
        return Util\Util::convertVisionRhythmObjectToStdObject($this->_values);
    }
}

VisionRhythmObject::init();
